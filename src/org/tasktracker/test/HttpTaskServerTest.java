...
public class HttpTaskServerTest {
    ...
    void whenRequestAllTasksThenGetAllTasks() throws IOException, InterruptedException {
        ...
        Task task = new Task("—ходить в магазин", " упить сыр, багет, помидоры, вино", LocalDateTime.of(2025, 2, 2, 12, 0), Duration.ofMinutes(30));
        task.setId(1);
        ...
        Task task1 = new Task("—ходить в магазин", " упить сыр, багет, помидоры, вино", LocalDateTime.of(2025, 2, 2, 12, 0), Duration.ofMinutes(30));
        task1.setId(2);
    ...
    void whenUpdateTaskThenCorrectPostTask() {
        ...
        Task task = new Task("—ходить в магазин", "вино", LocalDateTime.of(2024, 2, 2, 12, 0), Duration.ofMinutes(30));
        task.setId(1);
        String jsonOfTask1 = gson.toJson(task);
        final HttpRequest.BodyPublisher body1 = HttpRequest.BodyPublishers.ofString(jsonOfTask1);
        HttpRequest request1 = HttpRequest.newBuilder().uri(url).POST(body1).build();
